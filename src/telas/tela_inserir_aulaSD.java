 ...
 * @author Américo Ever
 */
public class tela_inserir_aulaSD extends javax.swing.JFrame {

    /**
     * Creates new form tela_inserir_aulaSD
     */
    public tela_inserir_aulaSD() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btn_select.setBounds(70, 529, 170, 40);

        jLabel2.setFont(new java.awt.Font("Segoe UI Semibold", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Caminho do Arquivo");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(70, 580, 190, 25);
        jPanel1.add(txt_caminho);
        txt_caminho.setBounds(70, 606, 660, 40);

        jLabel3.setFont(new java.awt.Font("Segoe UI Semibold", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Tema da aula");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(70, 660, 160, 25);
        jPanel1.add(txt_tema_aula);
        txt_tema_aula.setBounds(70, 696, 660, 40);
        ...
        btn_submeter.setBounds(780, 569, 170, 40);
        ...
        btn_clear.setBounds(780, 629, 170, 40);
    ...
    private void btn_submeterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_submeterActionPerformed
        ...
        if (txt_caminho.getText().isEmpty()) {
            ...
            try {
                ...
                String tema_sd = txt_tema_aula.getText();
                ...
                String sql = "insert into sd (tema_sd,conteudo_sd) values (?,?) ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tela_inserir_aulaSD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tela_inserir_aulaSD().setVisible(true);
            }
        });
    }
