 ...
 * @author Américo Ever
 */
public class tela_inserir_aulaPW extends javax.swing.JFrame {

    /**
     * Creates new form tela_inserir_aulaPW
     */
    public tela_inserir_aulaPW() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Aulas de Programacao WEB");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(330, 420, 310, 32);
        ...
        btn_select.setBounds(50, 519, 170, 40);

        jLabel2.setFont(new java.awt.Font("Segoe UI Semibold", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Caminho da aula");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(50, 570, 170, 25);
        jPanel1.add(txt_caminho);
        txt_caminho.setBounds(50, 596, 699, 40);

        jLabel3.setFont(new java.awt.Font("Segoe UI Semibold", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Tema da Aula");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(50, 650, 140, 25);
        jPanel1.add(txt_tema_aula);
        txt_tema_aula.setBounds(50, 686, 699, 40);
        ...
        btn_submeter.setBounds(780, 549, 160, 40);
        ...
        btn_clear.setBounds(780, 629, 160, 40);
    ...
    private void btn_submeterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_submeterActionPerformed
        ...
        if (txt_caminho.getText().isEmpty()) {
            ...
            try {
                ...
                String tema_pw = txt_tema_aula.getText();
                ...
                String sql = "insert into pw (tema_pw,conteudo_pw) values (?,?) ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tela_inserir_aulaPW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tela_inserir_aulaPW().setVisible(true);
            }
        });
    }
